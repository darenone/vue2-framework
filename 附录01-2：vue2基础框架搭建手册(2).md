...
组件地址：[src\components\element-table\TableView.vue](src\components\element-table\TableView.vue)，接收的参数有：
...
<template>
  <TableView
    ...
    :operate-width="pageName === 'manager' ? 210: 90"
    :options="{ seletion: true, pagination: false, sequence: false, expandAll: true }"
